...
$(document).ready(function(){
	...
	$('.slo_pic').transition({rotateX:'0deg',scale:'1'},700);
	$('.slo_pic').on('mouseover',function(){
		$(this).transition({rotateX:'45deg'},500)
	})
	$('.c2').on('mouseout',function(){
		$('.slo_pic').transition({rotateX:'0deg'},700);
	})
	...
	var skillZ = {
		...
		diagram: function(){
    		...
    		var circle = p.circle(800,185,100).attr({stroke:"red"}).glow({color:"red"});
    		var title = p.text(80+'%',65+'%','Skills').attr({fill:'red',font:'30px Arial'}).toFront();
            ...
            skills.each(function(i){
            	...
            	z.mouseover(function(){
	                ...
	                if(Raphael.type != 'VML') //solves IE problem
	                    this.toFront();
	                circle.attr({stroke:colors[i]}).glow({color:colors[i]});
	                title.animate({opacity:0},500, '>',function(){
	                	this.attr({text: text + ": " + value + '%',width:circle.getBBox().width}).animate({opacity:1},500,'<');
	                });
            	}).mouseout(function(){
